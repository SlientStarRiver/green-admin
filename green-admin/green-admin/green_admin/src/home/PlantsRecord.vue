        ...
        <div class="main-inner">
            ...
            <div class="table-card">
                <el-table :data="pagedData" stripe border style="width:100%" :empty-text="'暂无数据'">
                    ...
                    <el-table-column prop="plantDate" label="种植时间" />
...
export default {
    ...
    data() {
        return {
            ...
            records: [
                { id: 1, owner: '王明', block: 'qk01', species: '黄杨', plantDate: '2025-08-03', count: 5, note: '无' },
                { id: 2, owner: '王明', block: 'qk01', species: '黄杨', plantDate: '2025-08-03', count: 5, note: '无' },
                { id: 3, owner: '王明', block: 'qk01', species: '黄杨', plantDate: '2025-08-03', count: 5, note: '无' },
                { id: 4, owner: '王明', block: 'qk01', species: '黄杨', plantDate: '2025-08-03', count: 5, note: '无' },
                { id: 5, owner: '王明', block: 'qk01', species: '黄杨', plantDate: '2025-08-03', count: 5, note: '无' },
                { id: 6, owner: '王明', block: 'qk01', species: '黄杨', plantDate: '2025-08-03', count: 5, note: '无' },
                { id: 7, owner: '王明', block: 'qk01', species: '黄杨', plantDate: '2025-08-03', count: 5, note: '无' }
            ],
            currentPage: 1,
            pageSize: 6
        }
